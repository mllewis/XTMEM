...
shinyApp(
  ...
  ui = fluidPage(
    ...
    tags$head(tags$style(HTML('#go{background-color:red}'))),
  ...
  server = function(input, output) {
    ...
    output$exp_description <- renderText({
       ...
       html_string <- paste0("http://langcog.stanford.edu/expts/MLL/XTMEM/exp", exp_original, "/exp", exp_original, ".html")
       return(browseURL(html_string))
