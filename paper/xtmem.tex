...
their commonalities and increases memory consolidation {[}Lawson 2015
and 2017{]}, thus predicting \emph{broader} generalization in the
sequential condition. FIX THIS PARAGRAPHsequential condition: broader
generalization \%Indeed, several findings suggest that preschoolers
demonstrate the suspicious coincidence effect when generalizing
properties under sequential presentation ({\textbf{???}}), and that this
effect disappears under simultanous presentation ({\textbf{???}};
Lawson, 2017). {[}check these citations - I think they're out of
order{]}

On the other hand, another possible reconciliation of the empirical
picture is that the original effects were overestimated---consistent
with our previous work on another \enquote{suspicious coincidence}
finding (Lewis \& Frank, 2016; Xu \& Tenenbaum, 2007a)---but also highly
