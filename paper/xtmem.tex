...
evidence to suggest such a reversal in an analysis across all
experiments with the 3-1 ordering (\emph{t}(581) = -2.23; \emph{p} =
0.03; \emph{d} = -0.18 {[}-0.2, -0.16{]}).
...
sampling effects more broadly. Our findings do, however, highlight the
