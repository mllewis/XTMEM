...
SI)\footnote{Supplemental information can be found at [https://mlewis.shinyapps.io/xtmem_SI/](https://mlewis.shinyapps.io/xtmem_SI/)}.
...
\caption{\label{fig:unnamed-chunk-3}Effect sizes for all 19 studies
...
\caption{\label{tab:unnamed-chunk-4}Meta-analytic model with manipulations as fixed effects.}
\centering
\fontsize{12}{14}\selectfont
