...
Our data also suggest that the 3-1 ordering interacts with presentation timing: In experiments with the 3-1 ordering and sequential presentation (Exp.\ 10-12), we see a reliable reversal of the suspicious coincident effect (*t*(`r ceiling(t_test_three_one_sequential$parameter)`) = `r t_statistic_3_1_seq`; *p* = `r p_statistic_3_1_seq`; *d* = `r three_one_sequential_effect_size$d_string`). This reversal is attributable to increased generalizations to the basic level when the three subordinate trials are presented sequentially (Exp.\ 10-12) compared to simultaneously (Exp.\ 4-6). Though speculative, we hypothesize that this difference may be due to the fact that sequential presentation conditions may have appeared relatively more complex to participants compared to simultaneous presentation conditions, resulting in higher overall uncertainty in generalization jugdements. We speculate that this increased uncertainty may have lead participants to be more likely to generalize conservatively---at the basic level---on the first trial when exemplars were presented sequentially as opposed to simultaneously. 
