...
Figure \ref{fig:means_fig}shows the mean proportion generalizations to the basic level in the one- and three-subordinate trials for all 12 experiments\footnote{See SI for means across all measures and conditions}, and Figure \ref{fig:effect_sizes_fig} shows the corresponding effect sizes (with XT and SPSS experiments included for reference). 
