...
all_d <- read_csv("../data/anonymized_data/all_data_munged_A.csv") %>%
  filter(prop_sub <= 1 | prop_bas <= 1| prop_sup <= 1) # there were 28 trials across all 12 experiments (.4%) in which there was an error in data recording such that proportion selected of a category was greater than 1 (these were evenly distributed across the experiments).
