...
// -- Words--
var words = shuffle(["wug", "rab", "fep", "rif", "mep", "tob",  "tev", "sib", "zom", "nam", "dax", "gid"])
var sub_words = words.slice(0,3)
var other_words = words.slice(3,12)
...
var  second_blocks = shuffle(["one",  "3bas", "3sup"])

var blocks = [].concat.apply([], ["3sub", second_blocks])

// PRE-LOAD IMAGES
var all_pics = [].concat.apply([], [train_one_pics, train_3sub_pics, train_3bas_pics, 
  train_3sup_pics, test_pics], "mrfrog.png")
