...
```{r}
d$SubmitTime = gsub("T|Z","",d$SubmitTime)
d$AcceptTime = gsub("T|Z","",d$AcceptTime)
d$SubmitTime = strptime(d$SubmitTime, "%F%T")
d$AcceptTime = strptime(d$AcceptTime, "%F%T")
total_time = d$SubmitTime - d$AcceptTime 

boxplot(as.numeric(total_time))
mean(as.numeric(total_time))
```
